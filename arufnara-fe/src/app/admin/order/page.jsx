...
const AdminOrder = () => {
  ...
  const filteredOrders = orders.filter((order) => {
    ...
    const searchString = `${order.id || order._id || ""}${order.user_id || ""}${
      order.ml_user_id || ""
    }${order.server_id || ""}${order.payment_method || ""}`.toLowerCase();
                  ...
                  >
                    <td className="px-6 py-4 font-semibold text-blue-900 border-b border-blue-100 whitespace-nowrap">
                      <span className="inline-block px-2 py-1 bg-blue-200 text-blue-800 rounded-lg text-xs font-mono tracking-wider shadow-sm">
                        TRX00{order.id || order._id}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-blue-900 border-b border-blue-100 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-300 to-blue-500 flex items-center justify-center text-white font-bold text-sm shadow">
                          {(
                            order.user_name ||
                            order.user?.name ||
                            order.user_id ||
                    ...
                    <td className="px-6 py-4 text-blue-800 border-b border-blue-100 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 text-blue-900 border-b border-blue-100 whitespace-nowrap">
                      <span className="inline-block px-2 py-1 bg-blue-50 border border-blue-100 rounded-lg text-xs font-semibold">
                        {formatTopup(order)}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-blue-900 border-b border-blue-100 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 border-b border-blue-100 whitespace-nowrap">
                      <span
                        className={`inline-flex px-2 py-1 rounded-full text-xs font-bold shadow-sm ${getStatusClass(
                          order.status
                        )}`}
                      >
                    ...
                    <td className="px-6 py-4 border-b border-blue-100 whitespace-nowrap">
                      <div className="flex gap-2">
                        <button
                          ...
                          className="inline-flex items-center px-3 py-1 text-xs font-semibold text-blue-700 transition-colors bg-blue-100 rounded-lg hover:bg-blue-200 shadow"
                          disabled={loading}
                        >
